...
const Cgu = () => {
  return (
    <div className="cgu">
      <h1>Objet</h1>
      <p>
        Les présentes Conditions générales d'utilisation (CGU) ont pour objet de définir les termes et conditions dans lesquelles le site Théo Brasseur fournit les services aux utilisateurs/trices. Toute utilisation de l'un des services offerts par Théo Brasseur se fera dans le respect des présentes CGU.
      ...
      <h1>Conditions d'accès au contenu</h1>
      <p>
