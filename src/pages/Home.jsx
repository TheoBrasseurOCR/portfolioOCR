      ...
      <div className="right-section">
        <div className="card-container">
          <Hcards title="<Présentation />" content={
              <>
                Je suis Théo Brasseur, <strong>un développeur web Full-Stack</strong> de 27 ans basé à Arras, en France. Mon expertise technique s'accompagne d'un <strong>excellent niveau d'anglais</strong>, me permettant de travailler efficacement à l'international.
              </>
            }
          />
