...
const MentionsLegales = () => {
  return (
    <div className="mentions-legales">
      ...
      <p>
        Nous vous rappelons les caractéristiques et les limites du réseau Internet et déclinons toute responsabilité liée aux conséquences de votre connexion à ce réseau via Théo Brasseur.
